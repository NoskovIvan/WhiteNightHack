...
from charge_schema import CHARGE_JOURNEY_MODEL
...
class ChargeAgent(OEFAgent):
    """Class that implements the behaviour of the charge agent."""
    ...
    def __init__(self, *args, **kwargs):
      super(ChargeAgent, self).__init__(*args, **kwargs)
...
#      self.prepare_contract()
    ...
    def on_cfp(self, msg_id: int, dialogue_id: int, origin: str, target: int, query: CFP_TYPES):
        ...
        proposal = Description({"price_per_20m": price})
...
if __name__ == "__main__":
    agent = ChargeAgent("charge", oef_addr="127.0.0.1", oef_port=10000)
    agent.connect()
    agent.register_service(77, agent.charge_description)
